...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/my_t4___LED_Project_.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED="my t4 c.c"

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED="${OBJECTDIR}/my t4 c.p1"
POSSIBLE_DEPFILES="${OBJECTDIR}/my t4 c.p1.d"

# Object Files
OBJECTFILES=${OBJECTDIR}/my\ t4\ c.p1

# Source Files
SOURCEFILES=my t4 c.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/my_t4___LED_Project_.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/my\ t4\ c.p1: my\ t4\ c.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	${MP_CC} --pass1 "my t4 c.c" $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir="${OBJECTDIR}" -N31 --warn=0 --runtime=default,+clear,+init,-keep,+osccal,-resetbits,-download,-stackcall,+clib --summary=default,-psect,-class,+mem,-hex --opt=default,+asm,-asmfile,-speed,+space,-debug,9 -D__DEBUG --debugger=pickit2  --double=24 --float=24 --addrqual=ignore --mode=pro -g --asmlist "--errformat=%f:%l: error: %s" "--msgformat=%f:%l: advisory: %s" "--warnformat=%f:%l warning: %s"
	@${MP_CC} --scandep  "my t4 c.c" $(MP_EXTRA_CC_PRE) -q --chip=$(MP_PROCESSOR_OPTION) -P  --outdir="${OBJECTDIR}" -N31 --warn=0 --runtime=default,+clear,+init,-keep,+osccal,-resetbits,-download,-stackcall,+clib --opt=default,+asm,-asmfile,-speed,+space,-debug,9 -D__DEBUG --debugger=pickit2  --double=24 --float=24 --addrqual=ignore --mode=pro -g --asmlist "--errformat=%f:%l: error: %s" "--msgformat=%f:%l: advisory: %s" "--warnformat=%f:%l warning: %s"
	@echo "${OBJECTDIR}/my t4 c.p1": > "${OBJECTDIR}/my t4 c.p1".d
	@cat "${OBJECTDIR}/my t4 c".dep >> "${OBJECTDIR}/my t4 c.p1".d
	@${FIXDEPS} "${OBJECTDIR}/my t4 c.p1.d" $(SILENT) -ht  -rsi ${MP_CC_DIR}../ 
